...
type metadataExactDecimalMigrator interface {
	Migrate(context.Context, ApplicationSchemaStore, []metadataExactDecimalTableMigration) error
}
...
type mysqlExactDecimalSQLProfile interface {
	...
	ExactDecimalColumnDefinition(context.Context, appschemastorage.QueryRower, string, string) (string, sql.NullString, error)
}

func (sqliteExactDecimalMigrator) Migrate(ctx context.Context, store ApplicationSchemaStore, migrations []metadataExactDecimalTableMigration) error {
	return store.migrateSQLiteExactDecimalTables(ctx, migrations)
}
func (postgresExactDecimalMigrator) Migrate(ctx context.Context, store ApplicationSchemaStore, migrations []metadataExactDecimalTableMigration) error {
	return store.migratePostgresExactDecimalTables(ctx, migrations)
}
func (mysqlExactDecimalMigrator) Migrate(ctx context.Context, store ApplicationSchemaStore, migrations []metadataExactDecimalTableMigration) error {
...
func (r ApplicationSchemaStore) migrateSQLiteExactDecimalTables(ctx context.Context, migrations []metadataExactDecimalTableMigration) error {
	profile, ok := r.storage.(interface {
		DisableExactDecimalForeignKeys(context.Context, appschemasqlite.ExactDecimalExecutor) error
		RestoreExactDecimalForeignKeys(context.Context, appschemasqlite.ExactDecimalExecutor) error
		VerifyExactDecimalForeignKeys(context.Context, appschemasqlite.ExactDecimalQueryer) error
	})
	if !ok {
...
func (r ApplicationSchemaStore) migrateSQLiteExactDecimalTableInTransaction(ctx context.Context, tx *sql.Tx, table string, columns []metadataExactDecimalColumn) error {
	profile, ok := r.storage.(interface {
...
func (r ApplicationSchemaStore) exactDecimalSourceHash(ctx context.Context, executor database.ActionExecutionExecutor, table string, columns []metadataExactDecimalColumn) (int64, string, error) {
...
func (r ApplicationSchemaStore) migratePostgresExactDecimalTables(ctx context.Context, migrations []metadataExactDecimalTableMigration) error {
...
func (r ApplicationSchemaStore) migratePostgresExactDecimalTableInTransaction(ctx context.Context, tx *sql.Tx, table string, columns []metadataExactDecimalColumn) error {
...
func (r ApplicationSchemaStore) migrateMySQLExactDecimalTable(ctx context.Context, table string, columns []metadataExactDecimalColumn) error {
...
func (r ApplicationSchemaStore) preflightMySQLExactDecimalTable(ctx context.Context, table string, columns []metadataExactDecimalColumn) error {
	profile, ok := r.storage.(mysqlExactDecimalSQLProfile)
	if !ok {
		return fmt.Errorf("mysql exact decimal SQL profile is required")
	}
...
func (r ApplicationSchemaStore) exactDecimalLogicalHash(ctx context.Context, executor database.ActionExecutionExecutor, table string, columns []metadataExactDecimalColumn, encoded bool, postSchemaChange ...bool) (int64, string, error) {
	selected := []string{"workspace_id", "id"}
	for _, column := range columns {
		selected = append(selected, column.field.Key)
	}
...
func (r ApplicationSchemaStore) recordExactDecimalEvidence(ctx context.Context, executor database.ActionExecutionExecutor, table string, columns []metadataExactDecimalColumn, rowCount int64, beforeHash, afterHash string) error {
