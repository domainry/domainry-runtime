...
func TestPublishDefinitionCommitsDefinitionVersionAuditAndActiveRevision(t *testing.T) {
	...
	definition, err := store.PublishDefinition(t.Context(), metadataTestInstallationScope(), "object", "account", appschemamodel.ApplicationDefinitionUpsertRequest{Payload: json.RawMessage(`{"key":"account","name":"Account"}`)}, audit)
	if err != nil {
		t.Fatal(err)
	}
...
func TestPublishDefinitionReplayDoesNotDuplicateVersionAuditOrRefreshIntent(t *testing.T) {
	...
	defer store.raw.Close()
	expectAbsent := ""
	request := appschemamodel.ApplicationDefinitionUpsertRequest{SourceKind: "builder_v4", SourceID: "task-1:create-account", ExpectedSchemaHash: &expectAbsent, Payload: json.RawMessage(`{"key":"account","name":"Account"}`)}
...
func TestPublishDefinitionRollsBackAllFactsWhenActiveRevisionFails(t *testing.T) {
	...
	if _, err := store.PublishDefinition(t.Context(), metadataTestInstallationScope(), "object", "account", appschemamodel.ApplicationDefinitionUpsertRequest{Payload: json.RawMessage(`{"key":"account","name":"Account"}`)}, audit); err == nil {
...
func TestMetadataFieldUpsertEndToEnd(t *testing.T) {
	...
	if _, err := store.UpsertApplicationDefinition(t.Context(), "object", "e2e_item", appschemamodel.ApplicationDefinitionUpsertRequest{Payload: json.RawMessage(objJSON)}); err != nil {
		t.Fatalf("UpsertApplicationDefinition object: %v", err)
	}
	...
	req := appschemamodel.ApplicationDefinitionUpsertRequest{
		Payload:   json.RawMessage(payloadJSON),
		ObjectKey: "e2e_item",
	}
	def, err := store.UpsertApplicationDefinition(t.Context(), "field", "e2e_item.test_notes", req)
	if err != nil {
		t.Fatalf("UpsertApplicationDefinition field: %v", err)
	}
	if def.ResourceKey == "" {
	...
	plan, err := store.ApplicationSchemaMigrationPlan(t.Context(), manifest)
	if err != nil {
		t.Fatalf("ApplicationSchemaMigrationPlan: %v", err)
	}
	if len(plan) != 0 {
...
func TestApplicationDefinitionUpsertUsesExpectedSchemaHash(t *testing.T) {
	store := openStoreForMetadataTest(t)
	...
	expectAbsent := ""
	created, err := store.UpsertApplicationDefinition(t.Context(), "object", "account", appschemamodel.ApplicationDefinitionUpsertRequest{ExpectedSchemaHash: &expectAbsent, Payload: json.RawMessage(`{"key":"account","name":"Account"}`)})
	if err != nil {
		t.Fatal(err)
	}
	expected := created.SchemaHash
	updated, err := store.UpsertApplicationDefinition(t.Context(), "object", "account", appschemamodel.ApplicationDefinitionUpsertRequest{ExpectedSchemaHash: &expected, Payload: json.RawMessage(`{"key":"account","name":"Business Account"}`)})
	if err != nil {
		t.Fatal(err)
	}
	...
	_, err = store.UpsertApplicationDefinition(t.Context(), "object", "account", appschemamodel.ApplicationDefinitionUpsertRequest{ExpectedSchemaHash: &expected, Payload: json.RawMessage(`{"key":"account","name":"Stale Update"}`)})
	conflict, ok := err.(*appschemamodel.ApplicationDefinitionConflictError)
	...
	current, found, err := store.GetApplicationDefinition(t.Context(), "object", "account")
...
func TestApplicationDefinitionMutationBatchRollsBackOnVersionConflict(t *testing.T) {
	store := openStoreForMetadataTest(t)
	...
	first, err := store.UpsertApplicationDefinition(t.Context(), "object", "account", appschemamodel.ApplicationDefinitionUpsertRequest{Payload: json.RawMessage(`{"key":"account","name":"Account"}`)})
	if err != nil {
		t.Fatal(err)
	}
	second, err := store.UpsertApplicationDefinition(t.Context(), "object", "contact", appschemamodel.ApplicationDefinitionUpsertRequest{Payload: json.RawMessage(`{"key":"contact","name":"Contact"}`)})
	if err != nil {
		t.Fatal(err)
	}
	...
	_, err = store.ApplyDefinitionMutations(t.Context(), metadataTestInstallationScope(), []appschemamodel.ApplicationDefinitionMutation{
		{Operation: "update", ResourceType: "object", ResourceKey: "account", Request: appschemamodel.ApplicationDefinitionUpsertRequest{ExpectedSchemaHash: &firstHash, Payload: json.RawMessage(`{"key":"account","name":"Updated Account"}`)}},
		{Operation: "update", ResourceType: "object", ResourceKey: "contact", Request: appschemamodel.ApplicationDefinitionUpsertRequest{ExpectedSchemaHash: &staleSecondHash, Payload: json.RawMessage(`{"key":"contact","name":"Updated Contact"}`)}},
	...
	if _, ok := err.(*appschemamodel.ApplicationDefinitionConflictError); !ok {
		t.Fatalf("expected batch conflict, got %v", err)
	}
	currentFirst, _, _ := store.GetApplicationDefinition(t.Context(), "object", "account")
	currentSecond, _, _ := store.GetApplicationDefinition(t.Context(), "object", "contact")
...
func TestMetadataChangePlanUsesApplyingStateUntilRuntimeFinalizes(t *testing.T) {
	...
	definitions, err := store.ApplyDefinitionMutations(t.Context(), metadataTestInstallationScope(), []appschemamodel.ApplicationDefinitionMutation{{Operation: "create", ResourceType: "object", ResourceKey: "account", Request: appschemamodel.ApplicationDefinitionUpsertRequest{Payload: json.RawMessage(`{"key":"account","name":"Account"}`)}}}, nil, &changeplanmodel.BusinessChangePlanPublication{WorkspaceID: "default", PlanID: draft.PlanID, ExpectedRevision: draft.Revision, UpdatedBy: "admin", UpdatedAt: "2026-07-12T00:01:00Z"})
...
func TestMetadataChangePlanAndRollbackSynchronizeLocalizedProjectionAtomically(t *testing.T) {
	...
	definitions, err := store.ApplyDefinitionMutations(t.Context(), metadataTestInstallationScope(), []appschemamodel.ApplicationDefinitionMutation{{Operation: "create", ResourceType: "object", ResourceKey: "account", Request: appschemamodel.ApplicationDefinitionUpsertRequest{Payload: firstPayload, SourceID: "plan-localized-v1"}}}, nil, nil)
	if err != nil || len(definitions) != 1 {
	...
	definitions, err = store.ApplyDefinitionMutations(t.Context(), metadataTestInstallationScope(), []appschemamodel.ApplicationDefinitionMutation{{Operation: "update", ResourceType: "object", ResourceKey: "account", Request: appschemamodel.ApplicationDefinitionUpsertRequest{Payload: secondPayload, SourceID: "plan-localized-v2", ExpectedSchemaHash: &first.SchemaHash}}}, nil, nil)
	if err != nil || len(definitions) != 1 {
	...
	rolledBack, err := store.RollbackApplicationDefinition(t.Context(), "object", "account", appschemamodel.ApplicationDefinitionRollbackRequest{TargetVersion: first.SchemaVersion, ExpectedSchemaHash: second.SchemaHash, BusinessReason: "restore localization", ChangePlanID: "rollback-localized", BuilderTaskID: "builder-localized"}, auditmodel.AuditEvent{ID: "audit-localized", WorkspaceID: "default", Event: "metadata_definition.rolled_back", ActorID: "admin", CreatedAt: "2026-07-12T00:00:00Z"})
...
func assertLocalizedTextValue(t *testing.T, store *metadataTestStore, entityType, entityKey, property, locale, expected string) {
	t.Helper()
	values, err := store.ListLocalizedTexts(t.Context(), principalmodel.InstallationWorkspaceID, appschemamodel.LocalizedTextQuery{WorkspaceID: principalmodel.InstallationWorkspaceID, EntityType: entityType, EntityKey: entityKey, Property: property, Locale: locale})
...
func TestMetadataRollbackCreatesNewVersionAndUsesCurrentHash(t *testing.T) {
	...
	second, err := store.UpsertApplicationDefinition(t.Context(), "object", "account", appschemamodel.ApplicationDefinitionUpsertRequest{Payload: json.RawMessage(`{"key":"account","name":"Enterprise Account"}`)})
	if err != nil {
		t.Fatal(err)
	}
	request := appschemamodel.ApplicationDefinitionRollbackRequest{TargetVersion: first.SchemaVersion, ExpectedSchemaHash: second.SchemaHash, ChangePlanID: "rollback-plan"}
	...
	rolledBack, err := store.RollbackApplicationDefinition(t.Context(), "object", "account", request, audit)
	if err != nil {
		t.Fatal(err)
	}
	...
	versions, err := store.ListApplicationDefinitionVersions(t.Context(), "object", "account")
	if err != nil || len(versions) != 3 {
		t.Fatalf("rollback history was not append-only: versions=%#v err=%v", versions, err)
	}
	_, err = store.RollbackApplicationDefinition(t.Context(), "object", "account", appschemamodel.ApplicationDefinitionRollbackRequest{TargetVersion: second.SchemaVersion, ExpectedSchemaHash: second.SchemaHash, ChangePlanID: "stale"}, auditmodel.AuditEvent{ID: "audit-stale", WorkspaceID: "default"})
	if conflict, ok := err.(*appschemamodel.ApplicationDefinitionConflictError); !ok || conflict.CurrentHash != rolledBack.SchemaHash {
...
func TestManifestMetadataSyncAddsPluginDefinitionsWithoutOverwritingUserDefinitions(t *testing.T) {
	...
	if _, err := store.UpsertApplicationDefinition(t.Context(), "field", "customer.phone", appschemamodel.ApplicationDefinitionUpsertRequest{
