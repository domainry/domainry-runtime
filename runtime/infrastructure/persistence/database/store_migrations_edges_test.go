...
func TestMigrationApplicationLedgerAndContextEdges(t *testing.T) {
	...
	closedStore := &RuntimeStore{db: closedDB, dialect: sqlite.Dialect{}}
	_ = closedDB.Close()
...
func TestMigrationPathIdentityAndSQLHelperEdges(t *testing.T) {
	...
	rootFailure := &RuntimeStore{dialect: sqlite.Dialect{}, migrationReadDir: func(path string) ([]os.DirEntry, error) {
...
func TestMigrationScriptedSQLFailureEdges(t *testing.T) {
	...
	mysqlStore.dialect = mysql.Dialect{}
