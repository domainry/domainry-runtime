...
func EnsureEvidenceSchema(ctx context.Context, s Store) error {
	...
	tables := map[string][]string{
		...
		"report_export_artifacts": {
			"id " + text + " PRIMARY KEY", "workspace_id " + idempotencyScopeText + " NOT NULL", "report_key " + idempotencyScopeText + " NOT NULL", "object_key " + text + " NOT NULL", "audit_id " + text + " NOT NULL", "business_download_id " + text + " NOT NULL DEFAULT ''", "requester_user_id " + idempotencyScopeText + " NOT NULL", "role_key " + text + " NOT NULL", "idempotency_key " + idempotencyScopeText + " NOT NULL",
		...
		"record_batch_job_chunks": {
			"workspace_id " + idempotencyScopeText + " NOT NULL",
			"job_id " + idempotencyScopeText + " NOT NULL",
