...
var disableRemovedGeneratedAutomationRulesForManifest = func(ctx context.Context, store MetadataStore, tx *sql.Tx, manifest manifestmodel.ManifestSchema, now string) error {
...
func (s MetadataStore) disableRemovedGeneratedAutomationRules(ctx context.Context, tx *sql.Tx, manifest manifestmodel.ManifestSchema, now string) error {
