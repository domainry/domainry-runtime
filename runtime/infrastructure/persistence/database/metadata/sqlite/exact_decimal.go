...
func (MetadataStorageProfile) ExactDecimalCreateShadowTableSQL(renderer ormbuilder.Renderer, table, body, suffix string) string {
	return "CREATE TABLE " + renderer.Table(table) + " (" + body + ")" + suffix
}

func (MetadataStorageProfile) ExactDecimalCopySQL(renderer ormbuilder.Renderer, target, source string, columns, expressions []string) string {
...
func (MetadataStorageProfile) ExactDecimalDropTableSQL(renderer ormbuilder.Renderer, table string) string {
	return "DROP TABLE " + renderer.Table(table)
}

func (MetadataStorageProfile) ExactDecimalRenameTableSQL(renderer ormbuilder.Renderer, from, to string) string {
...
func (MetadataStorageProfile) DisableExactDecimalForeignKeys(ctx context.Context, executor ExactDecimalExecutor) error {
	_, err := executor.ExecContext(ctx, "PRAGMA foreign_keys = OFF")
	return err
}

func (MetadataStorageProfile) RestoreExactDecimalForeignKeys(ctx context.Context, executor ExactDecimalExecutor) error {
	_, err := executor.ExecContext(ctx, "PRAGMA foreign_keys = ON")
	return err
}

func (MetadataStorageProfile) VerifyExactDecimalForeignKeys(ctx context.Context, queryer ExactDecimalQueryer) error {
...
func (MetadataStorageProfile) ExactDecimalEncodeExpression(renderer ormbuilder.Renderer, column string, precision, scale int, roundingMode string) string {
...
func (MetadataStorageProfile) ExactDecimalWritableColumns(ctx context.Context, queryer ExactDecimalQueryer, table string) ([]string, error) {
...
func (MetadataStorageProfile) ExactDecimalSchemaArtifacts(ctx context.Context, queryer ExactDecimalQueryer, table string) ([]string, error) {
...
func (MetadataStorageProfile) RewriteExactDecimalDDL(createSQL string, targets map[string]string) (string, string, error) {
