...
func (r MetadataStore) LoadManifest(ctx context.Context, scope principalmodel.SystemScope) (manifestmodel.ManifestSchema, error) {
	...
	dictionaries, err := loadMetadataSliceContext[metadatamodel.DictionarySchema](ctx, r.database(), r.store, "dictionary_definitions")
	if err != nil {
		return manifestmodel.ManifestSchema{}, err
	}
...
func (r MetadataStore) ListDefinitions(ctx context.Context, scope principalmodel.SystemScope, resourceType string) ([]metadatamodel.MetadataDefinition, error) {
	if err := requireMetadataInstallationScope(scope); err != nil {
		return nil, err
	}
...
func (r MetadataStore) GetDefinition(ctx context.Context, scope principalmodel.SystemScope, resourceType, resourceKey string) (metadatamodel.MetadataDefinition, bool, error) {
	if err := requireMetadataInstallationScope(scope); err != nil {
	...
	definition, err := scanMetadataDefinition(r.database().QueryRowContext(ctx, query, args...), resourceType)
...
func (r MetadataStore) ListDefinitionVersions(ctx context.Context, scope principalmodel.SystemScope, resourceType, resourceKey string) ([]metadatamodel.MetadataDefinitionVersion, error) {
	if err := requireMetadataInstallationScope(scope); err != nil {
		return nil, err
	}
...
func (r MetadataStore) metadataDefinitionReplay(ctx context.Context, scope principalmodel.SystemScope, resourceType, resourceKey, targetHash string, expectedHash *string) (metadatamodel.MetadataDefinition, bool, error) {
