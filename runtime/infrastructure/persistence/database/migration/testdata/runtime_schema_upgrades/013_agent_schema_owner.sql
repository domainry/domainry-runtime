...
INSERT INTO _audit_events VALUES ('audit-013', 'workspace-primary', 'fixture.created', '', '', 'system', '', 'v013', '{}', '{}', '{}', '2026-08-30T00:00:00Z');
...
) VALUES ('workspace-primary','workflow-013','fixture','Fixture','manual','completed','{}','{}','{}','2026-08-30T00:00:00Z','2026-08-30T00:00:00Z');

CREATE TABLE surface_definitions (id TEXT PRIMARY KEY);
CREATE TABLE component_definitions (id TEXT PRIMARY KEY);
CREATE TABLE view_definitions (id TEXT PRIMARY KEY);
CREATE TABLE entrypoint_definitions (id TEXT PRIMARY KEY);
