-- Historical SQLite fixture for Runtime schema 025. It contains the durable
-- rows asserted by the upgrade matrix and the time-zone aware application header with the definition upgrade receipt ledger and no per-instance approval route table.
...
INSERT INTO _audit_events VALUES ('audit-025', 'workspace-primary', 'fixture.created', '', '', 'system', '', 'v025', '{}', '{}', '{}', '2026-09-07T00:00:00Z');
...
) VALUES ('workspace-primary','workflow-025','fixture','Fixture','manual','completed','{}','{}','{}','2026-09-07T00:00:00Z','2026-09-07T00:00:00Z');
...
INSERT INTO _application_schema_projection (id,template_id,name) VALUES ('current','legacy-025','Legacy application');
