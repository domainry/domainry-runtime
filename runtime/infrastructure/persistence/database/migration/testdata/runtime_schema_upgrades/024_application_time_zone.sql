-- Historical SQLite fixture for Runtime schema 024. It contains the durable
-- rows asserted by the upgrade matrix and the time-zone aware application header and pre-definition-upgrade-receipt shapes.
...
INSERT INTO _audit_events VALUES ('audit-024', 'workspace-primary', 'fixture.created', '', '', 'system', '', 'v024', '{}', '{}', '{}', '2026-09-07T00:00:00Z');
...
) VALUES ('workspace-primary','workflow-024','fixture','Fixture','manual','completed','{}','{}','{}','2026-09-07T00:00:00Z','2026-09-07T00:00:00Z');
...
INSERT INTO _application_schema_projection (id,template_id,name) VALUES ('current','legacy-024','Legacy application');
