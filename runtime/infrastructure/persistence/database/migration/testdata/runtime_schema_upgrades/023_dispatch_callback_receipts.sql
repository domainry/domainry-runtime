-- Historical SQLite fixture for Runtime schema 023. It contains the durable
-- rows asserted by the upgrade matrix and the pre-time-zone application header and dispatch callback receipt shapes.
...
INSERT INTO _audit_events VALUES ('audit-023', 'workspace-primary', 'fixture.created', '', '', 'system', '', 'v023', '{}', '{}', '{}', '2026-09-07T00:00:00Z');
...
) VALUES ('workspace-primary','workflow-023','fixture','Fixture','manual','completed','{}','{}','{}','2026-09-07T00:00:00Z','2026-09-07T00:00:00Z');
...
INSERT INTO _application_schema_projection (id,template_id,name) VALUES ('current','legacy-023','Legacy application');
