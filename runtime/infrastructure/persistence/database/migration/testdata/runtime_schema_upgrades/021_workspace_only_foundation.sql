-- Historical SQLite fixture for the immediately preceding Runtime schema.
-- It contains the two durable rows asserted by the upgrade matrix plus the
-- workspace authority shape already established by Runtime 021.
...
INSERT INTO _audit_events VALUES ('audit-021', 'workspace-primary', 'fixture.created', '', '', 'system', '', 'v021', '{}', '{}', '{}', '2026-09-07T00:00:00Z');
...
) VALUES ('workspace-primary','workflow-021','fixture','Fixture','manual','completed','{}','{}','{}','2026-09-07T00:00:00Z','2026-09-07T00:00:00Z');
