...
func TestRuntimeTargetPackageNamesMatchOwners(t *testing.T) {
	...
	targets := map[string]string{
		...
		"domain/metadata/model":                                  "metadatamodel",
		...
		"infrastructure/persistence/database/audit":              "audit",
		...
		"infrastructure/persistence/database/metadata":           "metadata",
		...
		"transport/http/metadata":                                "metadata",
