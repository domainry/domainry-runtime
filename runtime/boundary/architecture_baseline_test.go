...
func TestRuntimeTargetPackageNamesMatchOwners(t *testing.T) {
	...
	targets := map[string]string{
		...
		"domain/report/query":                             "query",
		"domain/report/query/dataset":                     "dataset",
		"domain/report/query/objectsql":                   "objectsql",
		"domain/report/snapshot":                          "snapshot",
...
func TestRuntimeDatabaseRootContainsOnlyTechnicalSubstrate(t *testing.T) {
	...
	allowed := map[string]bool{
		...
		"store_sql.go": true, "workspace_scope_migration.go": true,
	}
