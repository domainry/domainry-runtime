...
var reviewedWorkspaceSQLTables = map[string]bool{
	...
	"_audit_export_artifacts":             true,
	"_application_schema_localized_texts": true, "_record_localized_values": true,
	"_integration_api_keys": true, "_integration_connections": true, "_integration_credential_refresh_leases": true,
	"_integration_event_mapping_intents": true, "_integration_events": true, "_integration_external_identities": true,
	"_integration_invocations": true, "_publication_outbox": true, "_integration_secret_materials": true, "_integration_secrets": true,
	"_integration_connector_provider_states": true,
	"_integration_webhook_nonces":            true, "_integration_webhook_subscriptions": true, "_notification_delivery_reservations": true,
