...
func TestWorkflowAssigneeResolverValidationMatrix(t *testing.T) {
	tests := []struct {
		...
		{name: "manager", resolver: definitionmodel.WorkflowAssigneeResolver{Type: "manager", UserField: "manager_id"}, want: true},
		{name: "manager empty", resolver: definitionmodel.WorkflowAssigneeResolver{Type: "manager"}},
		{name: "manager of", resolver: definitionmodel.WorkflowAssigneeResolver{Type: "manager_of", UserField: " requester_id "}, want: true},
		{name: "manager of empty", resolver: definitionmodel.WorkflowAssigneeResolver{Type: "manager_of"}},
