...
func TestSnapshotReportPermissionAndObjectVisibilityIntersection(t *testing.T) {
	...
	assertReportKeys(t, reportKeys(SnapshotForPrincipal(snapshot, principal("workspace.admin")).Reports), "order_line_permission", "finance_permission", "object_visibility", "global")
