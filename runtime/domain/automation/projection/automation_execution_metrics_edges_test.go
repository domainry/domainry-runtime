...
func TestBuildAutomationExecutionMetricsBoundaries(t *testing.T) {
	...
	invocations := []integrationmodel.IntegrationInvocation{{ID: "i1", Status: "success", DurationMS: 8}, {ID: "i2", Status: "sent", DurationMS: 12}, {ID: "missing", Status: "failed", DurationMS: 99}}
	outbox := []integrationmodel.IntegrationOutboxMessage{{EventID: "e1", Status: "dead_lettered", AttemptCount: 2}, {EventID: "e1", Status: "retry", AttemptCount: 1}, {EventID: "missing", AttemptCount: 4}}
	...
	failed := BuildAutomationExecutionMetrics([]automationmodel.AutomationRuleExecution{{Trace: map[string]any{"actions": []any{map[string]any{"invocation_id": "i"}}}}}, []integrationmodel.IntegrationInvocation{{ID: "i", Status: "failed"}}, nil)
