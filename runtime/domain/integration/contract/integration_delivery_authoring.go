...
func integrationCatalogAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		ConfigurationRoutes: []string{"GET /integrations/connectors"}, Execution: &capabilitycontract.CapabilityAuthoringExecution{ReadSet: []string{"integration.connector_definition"}, Transaction: "read_only", Idempotency: "naturally_idempotent", SideEffectLevel: "none", PermissionModel: "integration.catalog.view"},
...
func integrationOfflineEventRecoveryAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		ConfigurationRoutes: []string{"POST /integrations/events/recover-offline"}, InputSchema: input, OutputSchema: output,
...
func integrationReadCapability(key, route string, parameters []capabilitycontract.CapabilityAuthoringParameter, collectionKey string, item capabilitycontract.CapabilityAuthoringSchema, symbol string, references []capabilitycontract.CapabilityAuthoringReference) capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		ConfigurationRoutes: []string{route}, InputSchema: input, OutputSchema: &output,
...
func integrationOutboxEnqueueAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Permissions: []string{"integration.invoke"}, AuditEvents: []string{"integration_outbox_enqueued"}, ConfigurationRoutes: []string{"POST /integrations/outbox"}, InputSchema: input, OutputSchema: integrationOutboxMessageSchemaPointer(),
...
func integrationOutboxStatusAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Permissions: []string{"integration.invoke"}, AuditEvents: []string{"integration_outbox_status_updated"}, ConfigurationRoutes: []string{"POST /integrations/outbox/{messageID}/status"}, ResourceKeyPathParameter: "messageID", InputSchema: integrationParameterObjectSchema(parameters), OutputSchema: integrationOutboxMessageSchemaPointer(),
...
func integrationOutboxRetryAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Permissions: []string{"integration.retry"}, AuditEvents: []string{"integration_outbox_retry_scheduled"}, ConfigurationRoutes: []string{"POST /integrations/outbox/{messageID}/retry"}, ResourceKeyPathParameter: "messageID", InputSchema: integrationParameterObjectSchema(parameters), OutputSchema: integrationOutboxMessageSchemaPointer(),
		OutputVariables: []capabilitycontract.CapabilityAuthoringOutput{{Name: "message_id", JSONPointer: "/id", Type: "integration_outbox_id", VisibleTo: "subsequent_capability_calls"}, {Name: "status", JSONPointer: "/status", Type: "string", VisibleTo: "subsequent_capability_calls"}},
