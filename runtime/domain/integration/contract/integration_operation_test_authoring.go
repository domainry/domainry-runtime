...
func IntegrationOperationTestAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		ConfigurationRoutes: []string{"POST /integrations/connections/{connectionKey}/test-operation"}, ResourceKeyPathParameter: "connectionKey", FrontendSupportKey: "integration.operation-test.v1",
		InputSchema: integrationOperationTestInputSchema(input, nil), OutputSchema: integrationOperationTestOutputSchema(input),
