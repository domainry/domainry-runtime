...
func IntegrationConnectorDefinitionAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Sources: []capabilitycontract.CapabilityAuthoringSource{{Kind: "model", Path: "runtime/domain/integration/model/integration_definition.go", Symbol: "ConnectorSchema"}, {Kind: "validation", Path: "runtime/domain/appschema/validation/appschema_connector_validation.go", Symbol: "ApplicationSchemaValidateConnectorDefinitionIssues"}, {Kind: "service", Path: "runtime/application/appschema/appschema_definition_validation_application_service.go", Symbol: "ApplicationSchemaApplicationService.ValidateApplicationDefinitionPayload"}},
	}
}
