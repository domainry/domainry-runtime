...
func MetadataNormalizeFieldMutation(request metadatamodel.MetadataDefinitionUpsertRequest, objects []definitionmodel.ObjectSchema, allowedFieldTypes []string, existingRecords []recordmodel.Record, existingRecordCount int) (metadatamodel.MetadataDefinitionUpsertRequest, error) {
