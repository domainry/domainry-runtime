...
// MetadataValidateObjectDefinition validates the independently authorable
...
func MetadataValidateObjectDefinition(resourceKey string, payload json.RawMessage) (json.RawMessage, error) {
