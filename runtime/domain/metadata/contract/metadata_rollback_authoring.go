...
func MetadataRollbackAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Sources:   []capabilitycontract.CapabilityAuthoringSource{{Kind: "service", Path: "runtime/application/changeplan/changeplan_business_change_plan_draft_lifecycle_clone.go", Symbol: "CloneCurrentDraft"}, {Kind: "storage", Path: "runtime/infrastructure/persistence/database/metadata/definition_context_store.go", Symbol: "ApplyDefinitionMutations"}},
	}
}
