...
func MetadataFieldAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	payload := metadataFieldPayloadSchema(MetadataAuthoringFieldTypes())
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Parameters: []capabilitycontract.CapabilityAuthoringParameter{
			...
			{Key: "type", Type: "string", Required: true, Enum: MetadataAuthoringFieldTypes()},
