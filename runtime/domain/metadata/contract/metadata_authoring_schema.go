...
func VersionedMetadataDefinitionRequestSchema(payload capabilitycontract.CapabilityAuthoringSchema, objectKeyRequired bool) *capabilitycontract.CapabilityAuthoringSchema {
	return metadataAuthoringRequestSchema(payload, objectKeyRequired)
}

func VersionedMetadataDefinitionOutputSchema(payload capabilitycontract.CapabilityAuthoringSchema) *capabilitycontract.CapabilityAuthoringSchema {
...
func VersionedMetadataDefinitionOperations(resourceType string) *capabilitycontract.CapabilityAuthoringResourceOperations {
	return metadataResourceOperations(resourceType)
}

func VersionedMetadataDefinitionExecution(resource string) *capabilitycontract.CapabilityAuthoringExecution {
