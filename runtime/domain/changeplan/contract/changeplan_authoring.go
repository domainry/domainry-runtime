...
func ChangePlanCurrentStateSnapshotAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Permissions: []string{"runtime.businesssystem.business_system_snapshot"}, ConfigurationRoutes: []string{"GET /authoring/snapshot"},
...
func ChangePlanReferenceImpactAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Permissions: []string{"runtime.businessreferences.business_reference_impact"}, ConfigurationRoutes: []string{"GET /references", "GET /references/{resourceType}/{resourceKey}/impact"},
