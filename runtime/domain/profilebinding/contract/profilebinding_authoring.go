...
func ProfileBindingAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		ResourceOperations: appschemacontract.VersionedApplicationDefinitionOperations("identity_profile_binding"), FrontendSupportKey: "identity.profile-binding.v1", MinimumFrontendVersion: "0.1.0",
		InputSchema: appschemacontract.VersionedApplicationDefinitionRequestSchema(payload, false), OutputSchema: appschemacontract.VersionedApplicationDefinitionOutputSchema(payload),
