...
type bootstrapIdentityDirectoryStub struct{}
...
func (bootstrapIdentityDirectoryStub) ListRoles(context.Context, identitysdk.DirectoryQuery) ([]identitysdk.Role, error) {
	return nil, nil
}
