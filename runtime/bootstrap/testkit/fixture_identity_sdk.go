...
// grants from the Runtime Project model.
...
func (factory IdentityFactory) Open(_ context.Context, application identitysdk.ApplicationRef) (identitysdk.Binding, error) {
	...
	return &fixtureIdentityBinding{
		application: application, roles: factory.roles, users: factory.users, userRoles: factory.userRoles,
		sessions: map[string]fixtureIdentitySession{}, workflowWorkloads: map[string]identitysdk.WorkflowWorkloadBinding{},
	}, nil
}

type fixtureIdentitySession struct {
	subject string
	role    string
}

type fixtureIdentityBinding struct {
	identitysdk.Binding
	mu                       sync.RWMutex
	...
	users                    map[string]identitysdk.User
	userRoles                map[string][]string
	sessions                 map[string]fixtureIdentitySession
...
func (binding *fixtureIdentityBinding) Descriptor() identitysdk.Descriptor {
...
func (binding *fixtureIdentityBinding) Authentication() identitysdk.Authentication { return binding }
func (binding *fixtureIdentityBinding) Tokens() identitysdk.TokenVerifier          { return binding }
func (binding *fixtureIdentityBinding) Authorization() identitysdk.Authorization   { return binding }
func (binding *fixtureIdentityBinding) Principals() identitysdk.PrincipalResolver  { return binding }
func (binding *fixtureIdentityBinding) Projection() identitysdk.Projection         { return binding }
func (binding *fixtureIdentityBinding) Applications() identitysdk.ApplicationRegistry {
	return binding
}
func (binding *fixtureIdentityBinding) Permissions() identitysdk.PermissionRegistry { return binding }
func (binding *fixtureIdentityBinding) Credentials() identitysdk.CredentialManager  { return binding }
func (binding *fixtureIdentityBinding) WorkflowWorkloads() identitysdk.WorkflowWorkloadIdentity {
	return binding
}
func (binding *fixtureIdentityBinding) Close(context.Context) error { return nil }

func (binding *fixtureIdentityBinding) Providers(context.Context, identitysdk.ProviderQuery) ([]identitysdk.Provider, error) {
	return nil, nil
}

func (binding *fixtureIdentityBinding) LoginWithPassword(_ context.Context, request identitysdk.PasswordLoginRequest) (identitysdk.AuthSession, error) {
	...
	binding.mu.Lock()
	binding.sessions[token] = fixtureIdentitySession{subject: subject, role: role}
	binding.mu.Unlock()
	return binding.authSession(token, subject, role), nil
}

func (binding *fixtureIdentityBinding) BeginFederatedLogin(context.Context, identitysdk.BeginFederatedLoginRequest) (identitysdk.ProviderChallenge, error) {
	return identitysdk.ProviderChallenge{}, nil
}
func (binding *fixtureIdentityBinding) CompleteFederatedLogin(context.Context, identitysdk.CompleteFederatedLoginRequest) (identitysdk.FederatedLoginCompletion, error) {
	return identitysdk.FederatedLoginCompletion{}, nil
}
func (binding *fixtureIdentityBinding) ExchangeAuthorizationCode(context.Context, identitysdk.ExchangeAuthorizationCodeRequest) (identitysdk.AuthSession, error) {
	return identitysdk.AuthSession{}, nil
}
func (binding *fixtureIdentityBinding) VerifyOTP(context.Context, identitysdk.VerifyOTPRequest) (identitysdk.AuthSession, error) {
	return identitysdk.AuthSession{}, nil
}
func (binding *fixtureIdentityBinding) RefreshSession(_ context.Context, request identitysdk.RefreshRequest) (identitysdk.AuthSession, error) {
...
func (binding *fixtureIdentityBinding) LogoutSession(_ context.Context, request identitysdk.LogoutRequest) error {
	binding.mu.Lock()
	delete(binding.sessions, request.RefreshToken)
	binding.mu.Unlock()
	return nil
}
func (binding *fixtureIdentityBinding) CurrentSession(_ context.Context, request identitysdk.CurrentSessionRequest) (identitysdk.SessionView, error) {
...
func (binding *fixtureIdentityBinding) Verify(_ context.Context, request identitysdk.VerifyTokenRequest) (identitysdk.VerifiedToken, error) {
	session, found := binding.session(request.AccessToken)
	if !found {
...
func (binding *fixtureIdentityBinding) ResolveAccess(_ context.Context, request identitysdk.AccessBundleRequest) (identitysdk.AccessBundle, error) {
...
func (binding *fixtureIdentityBinding) Reauthorize(ctx context.Context, request identitysdk.DecisionRequest) (identitysdk.AccessDecision, error) {
...
func (binding *fixtureIdentityBinding) Resolve(ctx context.Context, request identitysdk.PrincipalResolutionRequest) (identitysdk.PrincipalResolution, error) {
...
func (binding *fixtureIdentityBinding) ApplyWorkflowWorkloadBindings(_ context.Context, request identitysdk.ApplyWorkflowWorkloadBindingsRequest) (identitysdk.ApplyWorkflowWorkloadBindingsResult, error) {
...
func (binding *fixtureIdentityBinding) GetWorkflowWorkloadBinding(_ context.Context, request identitysdk.GetWorkflowWorkloadBindingRequest) (identitysdk.WorkflowWorkloadBinding, error) {
	if err := request.Validate(); err != nil {
...
func (binding *fixtureIdentityBinding) resolveWorkflowWorkload(request identitysdk.PrincipalResolutionRequest) (identitysdk.PrincipalResolution, error) {
...
func (binding *fixtureIdentityBinding) matchesApplication(application identitysdk.ApplicationScope) bool {
...
func (binding *fixtureIdentityBinding) FindUser(_ context.Context, lookup identitysdk.UserLookup) (identitysdk.User, bool, error) {
	user, found := binding.users[string(lookup.UserID)]
	return user, found, nil
}
func (binding *fixtureIdentityBinding) FindOrganizationUnit(context.Context, identitysdk.OrganizationUnitLookup) (identitysdk.OrganizationUnit, bool, error) {
	return identitysdk.OrganizationUnit{}, false, nil
}
func (binding *fixtureIdentityBinding) ListUsers(context.Context, identitysdk.ProjectionQuery) ([]identitysdk.User, error) {
...
func (binding *fixtureIdentityBinding) ListRoles(context.Context, identitysdk.ProjectionQuery) ([]identitysdk.Role, error) {
...
func (binding *fixtureIdentityBinding) ListUserRoleAssignments(_ context.Context, query identitysdk.UserRoleAssignmentQuery) ([]identitysdk.UserRoleAssignment, error) {
...
func (binding *fixtureIdentityBinding) Register(_ context.Context, request identitysdk.ApplicationRegistration) (identitysdk.ApplicationRegistrationReceipt, error) {
...
func (binding *fixtureIdentityBinding) Reconcile(_ context.Context, request identitysdk.PermissionReconcileRequest) (identitysdk.PermissionReconcileReceipt, error) {
	if err := request.ValidateContract(); err != nil {
...
func (binding *fixtureIdentityBinding) CurrentSourceSnapshot(_ context.Context, request identitysdk.PermissionSourceSnapshotRequest) (identitysdk.PermissionSourceSnapshot, error) {
	if err := request.ValidateContract(); err != nil {
...
func (binding *fixtureIdentityBinding) ChangePassword(_ context.Context, request identitysdk.ChangePasswordRequest) (identitysdk.AuthSession, error) {
	session, found := binding.session(request.AccessToken)
	if !found {
		return identitysdk.AuthSession{}, &identitysdk.Error{Code: "auth.token_invalid", StatusCode: 401}
	}
...
func (binding *fixtureIdentityBinding) ResetPassword(context.Context, identitysdk.ResetPasswordRequest) error {
	return nil
}
func (binding *fixtureIdentityBinding) RevokeSessions(context.Context, identitysdk.RevokeSessionsRequest) error {
	return nil
}

func (binding *fixtureIdentityBinding) findSubject(login string) string {
...
func (binding *fixtureIdentityBinding) firstUserRole(subject string) string {
...
func (binding *fixtureIdentityBinding) session(token string) (fixtureIdentitySession, bool) {
	binding.mu.RLock()
...
func (binding *fixtureIdentityBinding) fixtureTokenSession(token string) (fixtureIdentitySession, bool) {
	token = strings.TrimSpace(token)
	if !strings.HasPrefix(token, identityFixtureTokenPrefix) {
		return fixtureIdentitySession{}, false
	}
	...
	return fixtureIdentitySession{subject: subject, role: roleKey}, true
}

func (binding *fixtureIdentityBinding) authSession(token, subject, roleKey string) identitysdk.AuthSession {
...
func (binding *fixtureIdentityBinding) accessBundle(subject, roleKey string) identitysdk.AccessBundle {
...
var _ identitysdk.Binding = (*fixtureIdentityBinding)(nil)
var _ identitysdk.WorkflowWorkloadIdentityBinding = (*fixtureIdentityBinding)(nil)
var _ identitysdk.WorkflowWorkloadIdentity = (*fixtureIdentityBinding)(nil)
