...
func newRuntimeServicesState(ctx context.Context, manifest manifestmodel.ManifestSchema, deps RuntimeServicesDependencies) *runtimeAssembly {
	...
	services := &runtimeAssembly{
		...
		verifyFileClean:                     bindActionVerifyFileClean(deps.VerifyFileClean),
		openVerifiedFile:                    bindActionOpenVerifiedFile(deps.OpenVerifiedFile),
		issueFileDownload:                   bindActionIssueFileDownload(deps.IssueFileDownload),
		createDerivedFile:                   bindActionCreateDerivedFile(deps.CreateDerivedFile),
