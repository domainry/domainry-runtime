...
func TestAutomationApplicationUsesCanonicalRuntimeServiceAndOwnerBoundaries(t *testing.T) {
	...
	configuredRuntime := newRuntimeServicesAssembly(t.Context(), RuntimeServicesConfig{
		...
		Dependencies: RuntimeServicesDependencies{IdentityPrincipals: agentPrincipalResolverStub{principal: automationPrincipal}},
	})
...
func TestMetadataProjectionReplacesRuntimeOwnedSchemaState(t *testing.T) {
	...
	runtime.applyManifestMetadata(" template ", " 1 ", " Runtime ", "Asia/Tokyo", objects, actions, workflows, nil, rules, nil, connectormodel.IntegrationSchema{}, nil, nil, nil, nil)
	...
	runtime.applyManifestMetadata("template", "2", "Runtime", "Asia/Shanghai", objects[1:], actions[1:], workflows[1:], nil, rules[1:], []appschemamodel.DictionarySchema{{Key: "status"}}, connectormodel.IntegrationSchema{}, nil, nil, nil, nil)
