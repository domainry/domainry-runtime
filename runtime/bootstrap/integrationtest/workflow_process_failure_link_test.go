...
func TestWorkflowGraphFailureAndDeadLetterLinkToProcessAndNode(t *testing.T) {
	...
	records := runtimetestkit.NewRuntimeServices(t.Context(), runtimetestkit.RuntimeServicesConfig{TemplateID: "workflow-links", TemplateVersion: "1", Name: "Workflow Links", Objects: nil, Views: nil, Actions: nil, Workflows: []definitionmodel.WorkflowSchema{workflow}, AutomationRules: nil, Dictionaries: nil, Integrations: integrationmodel.IntegrationSchema{}, Reports: nil, Entrypoints: nil, Skills: nil, Agents: nil, Store: store, WorkflowProcesses: workflowpersistence.NewWorkflowProcessStore(store), WorkflowWorker: workflowpersistence.NewWorkflowWorkerStore(store)})
