...
func addObjectOpenAPIPaths(paths map[string]any, object definitionmodel.ObjectSchema) {
	...
	paths["/records/objects/"+objectKey+"/records"] = map[string]any{
	...
	paths["/records/objects/"+objectKey+"/records/import/preview"] = map[string]any{
	...
	paths["/records/objects/"+objectKey+"/records/import/apply"] = map[string]any{
	...
	paths["/records/objects/"+objectKey+"/records/export"] = map[string]any{
		"post": exportDispatch,
	}
	paths["/records/objects/"+objectKey+"/records/{recordID}"] = map[string]any{
	...
	paths["/records/objects/"+objectKey+"/actions"] = map[string]any{
...
func addRuntimeContractOpenAPIPaths(paths map[string]any) {
	...
	paths["/records/objects/{objectKey}/fields/{fieldKey}/reference-options"] = map[string]any{
	...
	paths["/records/objects/{objectKey}/records/{recordID}/deactivate-profile"] = map[string]any{
	...
	paths["/records/objects/{objectKey}/records/{recordID}/reactivate-profile"] = map[string]any{
	...
	paths["/records/objects/{objectKey}/records/{recordID}/references"] = map[string]any{
	...
	paths["/records/objects/{objectKey}/records/{recordID}/related/{relatedObjectKey}"] = map[string]any{
	...
	paths["/records/objects/{objectKey}/actions/{actionKey}/run"] = map[string]any{
	...
	paths["/records/objects/{objectKey}/records/{recordID}/actions/{actionKey}"] = map[string]any{
	...
	paths["/metadata/execution-capabilities"] = map[string]any{
	...
	paths["/business-references/graph"] = map[string]any{
	...
	paths["/business-references/{resourceType}/{resourceKey}"] = map[string]any{
	...
	paths["/capabilities"] = map[string]any{
	...
	paths["/capabilities/index"] = map[string]any{
	...
	paths["/capabilities/domains/{domainKey}"] = map[string]any{
	...
	paths["/capabilities/{capabilityKey}"] = map[string]any{
	...
	paths["/capabilities/references/{kind}"] = map[string]any{
	...
	paths["/business-system/snapshot"] = map[string]any{
	...
	paths["/business-system/validation"] = map[string]any{
	...
	paths["/business-system/delivery-verification"] = map[string]any{
