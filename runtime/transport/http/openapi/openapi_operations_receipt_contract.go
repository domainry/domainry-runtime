...
func addOwnerOperationsReceiptOpenAPIContracts(paths map[string]any) {
	methods := map[string]string{
		...
		"/operations/integrations/events/{eventID}/retry":             "post",
		"/operations/integrations/events/{eventID}/replay":            "post",
		"/operations/integrations/outbox/{messageID}/retry":           "post",
