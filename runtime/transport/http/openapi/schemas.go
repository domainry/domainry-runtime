	...
	schemas := map[string]any{
		...
		"Record": map[string]any{
			...
			"properties": map[string]any{
				...
				"workspace_id":    map[string]any{"type": "string", "readOnly": true},
				...
				"deleted":         map[string]any{"type": "boolean", "readOnly": true},
				"ext_info":        map[string]any{"type": "object", "readOnly": true},
				"create_by":       map[string]any{"type": "string", "readOnly": true},
				"create_by_name":  map[string]any{"type": "string", "readOnly": true},
				"update_by":       map[string]any{"type": "string", "readOnly": true},
				"update_by_name":  map[string]any{"type": "string", "readOnly": true},
				"owner_user_id":   map[string]any{"type": "string", "readOnly": true},
				"owner_user_name": map[string]any{"type": "string", "readOnly": true},
				"owner_org_id":    map[string]any{"type": "string", "readOnly": true},
				"owner_org_name":  map[string]any{"type": "string", "readOnly": true},
