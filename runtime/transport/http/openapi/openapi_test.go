...
func TestOpenAPISpecCoversFrontendRuntimeContract(t *testing.T) {
	...
	required := map[string][]string{
		...
		"/frontend-capability-manifest":                                             {"get", "put"},
		...
		"/tenant-admin/change-plans/apply":                                          {"post"},
		"/tenant-admin/change-plans/{planID}/review":                                {"post"},
		"/tenant-admin/change-plans/{planID}/clone-current":                         {"post"},
		"/tenant-admin/change-plans/{planID}/simulate":                              {"post"},
		"/tenant-admin/change-plans/{planID}/approve":                               {"post"},
		"/tenant-admin/change-plans/{planID}/export":                                {"get"},
		"/tenant-admin/change-plans/{planID}/package":                               {"put"},
		...
		"/tenant-admin/integrations/connectors":                                     {"get"},
		"/tenant-admin/integrations/bindings/validate":                              {"post"},
		"/tenant-admin/integrations/connections":                                    {"get"},
		"/tenant-admin/integrations/connections/{connectionKey}":                    {"get", "put", "delete"},
		"/tenant-admin/integrations/connections/{connectionKey}/validate":           {"post"},
		"/tenant-admin/integrations/connections/{connectionKey}/versions":           {"get"},
		"/tenant-admin/integrations/connections/{connectionKey}/test-operation":     {"post"},
		"/tenant-admin/integrations/connections/{connectionKey}/oauth/google/start": {"post"},
		"/integrations/google/oauth/callback":                                       {"get"},
