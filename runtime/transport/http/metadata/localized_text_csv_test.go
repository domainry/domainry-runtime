...
func TestLocalizedTextCSVExportsStableKeysAndText(t *testing.T) {
	payload := localizedTextCSV([]metadatamodel.LocalizedText{
		{
			WorkspaceID: "default",
			EntityType:  "field",
...
func TestLocalizedTextXLSXExportsStableKeysAndText(t *testing.T) {
	payload := localizedTextXLSX([]metadatamodel.LocalizedText{
		{
			WorkspaceID: "default",
			EntityType:  "field",
			EntityKey:   "customer.status.active",
...
func TestLocalizedTextCSVImportValidatesSchemaKeys(t *testing.T) {
	requests := []metadatamodel.LocalizedTextUpsertRequest{
...
func TestLocalizedTextCSVImportRequiresEachValue(t *testing.T) {
	...
	if err := validateLocalizedTextUpsertRequests([]metadatamodel.LocalizedTextUpsertRequest{}, map[string]bool{}); err == nil {
