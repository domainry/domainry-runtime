...
func (h *ApplicationSchemaHandler) applyMetadataAuthoringHeaders(w http.ResponseWriter, r *http.Request, request *appschemamodel.ApplicationDefinitionUpsertRequest) bool {
