...
type metadataAuthoringValidationFailure struct {
	appschemamodel.ApplicationDefinitionValidationResult
...
func (h *ApplicationSchemaHandler) writeMetadataAuthoringValidationResult(w http.ResponseWriter, r *http.Request, result appschemamodel.ApplicationDefinitionValidationResult) {
	...
	h.writeJSON(w, http.StatusUnprocessableEntity, metadataAuthoringValidationFailure{
		ApplicationDefinitionValidationResult: result,
