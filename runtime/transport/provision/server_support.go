...
func (s *Server) v1Receipt(request map[string]any, manifest manifestmodel.ManifestSchema, manifestHash string, status string) map[string]any {
	return map[string]any{
		...
		"frontend_evidence_hash":            stringFromMap(request, "frontend_evidence_hash"),
		"frontend_capability_manifest_hash": stringFromMap(request, "frontend_capability_manifest_hash"),
		"frontend_design_contract_hash":     stringFromMap(request, "frontend_design_contract_hash"),
		"frontend_route_registry_hash":      stringFromMap(request, "frontend_route_registry_hash"),
		"frontend_source_hash":              stringFromMap(request, "frontend_source_hash"),
