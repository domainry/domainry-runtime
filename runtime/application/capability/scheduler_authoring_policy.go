...
func schedulerAuthoringDomain() capabilitycontract.CapabilityAuthoringDomain {
	return capabilitycontract.CapabilityAuthoringDomain{Key: "scheduler", Capabilities: []capabilitycontract.CapabilityAuthoringDefinition{
		...
		schedulerCommandAuthoringCapability("scheduler.job.simulate", "business_schedule_simulation", "definition_id", "POST /tenant-admin/scheduler/definitions/{definitionID}/simulate", false),
		...
		schedulerCommandAuthoringCapability("scheduler.run.retry", "business_administrator_recovery", "run_id", "POST /operations/scheduler/runs/{runID}/retry", true),
		schedulerCommandAuthoringCapability("scheduler.run.cancel", "business_administrator_recovery", "run_id", "POST /operations/scheduler/runs/{runID}/cancel", true),
...
func schedulerBusinessJobAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Sources: []capabilitycontract.CapabilityAuthoringSource{
			{Kind: "validation", Path: "runtime/application/scheduler/scheduler_validation.go", Symbol: "validateSchedulerDefinitionContract"},
...
func schedulerScheduleAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	return capabilitycontract.CapabilityAuthoringDefinition{
		...
		Sources: []capabilitycontract.CapabilityAuthoringSource{
			{Kind: "validation", Path: "runtime/application/scheduler/scheduler_validation.go", Symbol: "validateSchedulerScheduleFragment"},
			{Kind: "transport", Path: "runtime/transport/http/scheduler/scheduler_routes.go", Symbol: "RegisterRoutes"},
			{Kind: "service", Path: "runtime/application/scheduler/scheduler_application_service.go", Symbol: "SchedulerApplicationService.PreviewSchedule"},
		},
	}
}
...
func schedulerCommandAuthoringCapability(key, lifecycle, resourceParameter, route string, idempotencyRequired bool) capabilitycontract.CapabilityAuthoringDefinition {
	...
	capability := capabilitycontract.CapabilityAuthoringDefinition{
		...
		Sources:         []capabilitycontract.CapabilityAuthoringSource{{Kind: "transport", Path: "runtime/transport/http/scheduler/scheduler_handler.go", Symbol: schedulerCommandSymbol(key)}, {Kind: "transport", Path: "runtime/transport/http/scheduler/scheduler_routes.go", Symbol: "RegisterRoutes"}},
	}
...
func schedulerResolveDeadLetterAuthoringCapability() capabilitycontract.CapabilityAuthoringDefinition {
	...
	capability := schedulerCommandAuthoringCapability("scheduler.dead_letter.resolve", "business_administrator_recovery", "dead_letter_id", "POST /operations/scheduler/dead-letters/{deadLetterID}/resolve", true)
...
func schedulerCommandSymbol(key string) string {
	...
	case "scheduler.job.simulate":
		return "SchedulerHandler.simulateSchedulerJob"
	case "scheduler.job.run":
		return "SchedulerHandler.runOpsSchedulerJob"
	case "scheduler.run.retry":
		return "SchedulerHandler.retryOpsSchedulerRun"
	case "scheduler.run.cancel":
		return "SchedulerHandler.cancelOpsSchedulerRun"
	default:
		return "SchedulerHandler.resolveOpsSchedulerDeadLetter"
	}
}
