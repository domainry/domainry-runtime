...
func TestOperationsBreakGlassIsTimeLimitedDualApprovedAuditedAndRevisionFenced(t *testing.T) {
	...
	principal := accessfixture.Attach(principalmodel.Principal{Principal: identitysdk.Principal{Known: true, WorkspaceID: "workspace-a", UserID: "actor"}}, accessfixture.Bundle{Permissions: []string{"workspace.admin"}})
