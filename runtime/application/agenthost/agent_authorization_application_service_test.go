...
func TestGlobalAgentContextUsesTrustedCurrentRouteAndPrincipal(t *testing.T) {
	...
	request := GlobalAgentContextRequest{
		Principal: initiator, EntrypointKey: "assistant.global", RouteKey: "workspace.customer", ObjectKey: "customer",
...
func TestGlobalAgentContextBoundaryMatrix(t *testing.T) {
	base := func(initiator principalmodel.Principal) GlobalAgentContextRequest {
		return GlobalAgentContextRequest{Principal: initiator, EntrypointKey: "assistant.global", RouteKey: "workspace.customer", ObjectKey: "customer"}
	}
...
func TestAgentInteractiveAuthorizationBoundaryMatrix(t *testing.T) {
	...
	stored, err := service.ResolveGlobalContext(t.Context(), GlobalAgentContextRequest{Principal: initiator, EntrypointKey: "assistant.global", RouteKey: "workspace.customer", ObjectKey: "customer"})
	if err != nil {
		t.Fatal(err)
	}
