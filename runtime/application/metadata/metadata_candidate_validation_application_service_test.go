...
func (r metadataCandidateRepository) ListDefinitions(_ context.Context, _ principalmodel.SystemScope, resourceType string) ([]metadatamodel.MetadataDefinition, error) {
	return r.definitions[resourceType], r.definitionErrs[resourceType]
}

func (r metadataCandidateRepository) ListDefinitionVersions(_ context.Context, _ principalmodel.SystemScope, resourceType, resourceKey string) ([]metadatamodel.MetadataDefinitionVersion, error) {
...
func TestMetadataCandidateResolvesSchedulerTargetCreatedInSameDraft(t *testing.T) {
	...
	mutations := []metadatamodel.MetadataDefinitionMutation{
		{Operation: "create", ResourceType: "workflow", ResourceKey: "customer.refresh", Request: metadatamodel.MetadataDefinitionUpsertRequest{Payload: json.RawMessage(workflow)}},
		{Operation: "create", ResourceType: "scheduler", ResourceKey: "customer.refresh", Request: metadatamodel.MetadataDefinitionUpsertRequest{Payload: json.RawMessage(scheduler)}},
	}
	if err := service.ValidateMetadataCandidate(t.Context(), mutations); err != nil {
