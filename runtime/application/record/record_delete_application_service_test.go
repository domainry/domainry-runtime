...
func TestDeleteServiceOwnsSoftDeleteTransaction(t *testing.T) {
	...
	if commit.Operation != "update" || commit.Record.Data["status"] != "deleted" || commit.Record.Data["deleted_at"] != "2026-07-17T12:00:00Z" || commit.Record.Data["deleted_by"] != "admin" || commit.Record.Data["version"] != float64(3) {
