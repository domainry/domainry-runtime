...
func toRuntimeextPrincipal(principal principalmodel.Principal) runtimeext.Principal {
	result := runtimeext.Principal{UserID: principal.UserID, RoleKey: principal.RoleKey, DepartmentID: principal.DepartmentID, RequestID: principal.RequestID, CorrelationID: principal.CorrelationID, CausationID: principal.CausationID, SurfaceKey: principal.SurfaceKey, AuthorizationRevision: principal.AuthorizationRevision, Known: principal.Known}
