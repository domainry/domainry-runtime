...
func TestSnapshotWatcherBlankBaselineAndTickFailureConditions(t *testing.T) {
	...
	cancel()
	blank := newApplicationSchemaSnapshotWatcherApplicationService(ApplicationSchemaSnapshotWatcherDependencies{
