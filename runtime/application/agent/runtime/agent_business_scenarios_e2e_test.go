...
func resumeScreeningAuthorizationFixture() (*AgentAuthorizationApplicationService, principalmodel.Principal) {
	...
	schema := &agentSchemaProviderStub{full: full, filtered: map[string]metadatamodel.ApplicationSchemaSnapshot{"hr-user:hr_recruiter": filtered}}
