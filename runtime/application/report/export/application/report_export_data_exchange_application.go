...
func (s *ReportExportApplicationService) prepareExportJobFromPayload(ctx context.Context, payload reportexport.ExportPayload, fingerprint string, principal principalmodel.Principal) (reportexport.ExchangeJob, error) {
