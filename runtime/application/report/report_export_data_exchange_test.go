...
func TestNewReportExportJobWritesOnlyDataExchange(t *testing.T) {
	...
	service := &ReportApplicationService{dataExchange: exchange, dataExchangeProvider: reportexport.NewDataExchangeProvider(reportexport.DataExchangeDependencies{Binding: exchange}), clock: time.Now}
