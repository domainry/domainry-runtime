...
func publishDomainryDependencyClosure(repository, proxy string) ([]publishedDependencyModule, map[string]string, error) {
	...
	for _, local := range []struct {
		...
		{path: "github.com/domainry/domainry-todo", rootEnvironment: "DOMAINRY_TODO_REPO_ROOT", label: "Todo", patterns: []string{"./..."}},
		{path: "github.com/domainry/domainry-knowledge", rootEnvironment: "DOMAINRY_KNOWLEDGE_REPO_ROOT", label: "Knowledge", patterns: []string{"./..."}},
		{path: "github.com/domainry/domainry-tools", rootEnvironment: "DOMAINRY_TOOLS_REPO_ROOT", label: "Tools", patterns: []string{"./..."}},
...
func localDependencyModFile(repository string) (string, func(), error) {
	replacements := []struct{ path, environment string }{
		...
		{path: "github.com/domainry/domainry-connector-sdk", environment: "DOMAINRY_CONNECTOR_SDK_REPO_ROOT"},
		...
		{path: "github.com/domainry/domainry-tools-sdk", environment: "DOMAINRY_TOOLS_SDK_REPO_ROOT"},
		{path: "github.com/domainry/domainry-todo", environment: "DOMAINRY_TODO_REPO_ROOT"},
		{path: "github.com/domainry/domainry-knowledge", environment: "DOMAINRY_KNOWLEDGE_REPO_ROOT"},
		{path: "github.com/domainry/domainry-tools", environment: "DOMAINRY_TOOLS_REPO_ROOT"},
