...
func TestModuleHTTPAdaptersRejectCrossModuleNamespaceLeak(t *testing.T) {
	...
	_, err := mountModuleHTTPAdapters(runtimehttp.ListenerRouteGroupManagement, []modulehttp.Adapter{first, second}, nil, func(_ modulehttp.Route, handler http.Handler) (http.Handler, error) { return handler, nil })
